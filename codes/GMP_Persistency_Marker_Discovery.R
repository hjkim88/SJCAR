...
persistency_study <- function(Seurat_RObj_path="./data/NEW_SJCAR_SEURAT_OBJ/SJCAR19_Oct2020_Seurat_Obj.RDS",
  ...
  write.xlsx2(persister_meta,
              file = paste0(outputDir, "GMP_CD8_Persisters_VDJ_Annotated.xlsx"),
              sheetName = "GMP_CD8_Persisters_VDJ_Annotated",
              row.names = FALSE,
              append = FALSE)
  ...
  write.xlsx2(non_persister_meta,
              file = paste0(outputDir, "GMP_CD8_Non-Persisters_VDJ_Annotated.xlsx"),
